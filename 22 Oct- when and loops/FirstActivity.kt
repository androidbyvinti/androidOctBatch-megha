...
class FirstActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkButton.setOnClickListener {
            ...
            if(firstValue.text.isBlank()){
                //Predefined class in android --> message --> current class, message to deliver, message duration
                //Context --> parent --> without activity
                //Toast --> Toast- > long --> milliseconds
                //Toast --> Toast -> short -->
                Toast.makeText(this, R.string.message, 6000).show()
            }else {
                first  =  firstValue.text.toString().toInt()
            }
